...
export default function Body() {
    ...
    return (<>
        ...
        <section className="social-proof border-t-8 border-primary py-5">
            ...
            <p className="bg-white text-center pt-3 pb-[2.5rem] px-2 text-xl border-b-8 border-primary">I'm not one to blow my own trumpet, so I've dropped a few reviews from past and present students below...</p>
